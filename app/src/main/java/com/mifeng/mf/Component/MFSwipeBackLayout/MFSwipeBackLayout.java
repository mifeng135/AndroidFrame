...
public class MFSwipeBackLayout extends ViewGroup {
     ...
     * 滑动返回时的阴影视图
     */
    private MFSwipeBackShadowView mShadowView;
    /**
     * 内容视图
     */
    ...
    void attachToActivity(Activity activity) {
        ...
        mShadowView = new MFSwipeBackShadowView(activity);
    ...
    public MFSwipeBackLayout(Context context) {
        this(context, null);
    }

    public MFSwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MFSwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
...
//        int widthSize = MeasureSpec.getSize(widthMeasureSpec);
        int widthSize = UIUtil.getRealScreenWidth(Navigator.getInstance().getActivity());
//        int heightSize = MeasureSpec.getSize(heightMeasureSpec);
        int heightSize = UIUtil.getRealScreenHeight(Navigator.getInstance().getActivity());
        // ======================== 新加的 END ========================
        ...
        // ======================== 新加的 START ========================
        if (!mIsNavigationBarOverlap && UIUtil.isPortrait(Navigator.getInstance().getActivity())) {
            maxLayoutHeight -= UIUtil.getNavigationBarHeight(Navigator.getInstance().getActivity());
        }

        if (mIsNavigationBarOverlap && !UIUtil.isPortrait(Navigator.getInstance().getActivity())) {
            widthSize += UIUtil.getNavigationBarHeight(Navigator.getInstance().getActivity());
        }
        // ======================== 新加的 END ========================
...
//            mDragHelper.captureChildView(mSlideableView, pointerId);
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(MFSwipeBackLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        @Override
        public void invalidateChildRegion(MFSwipeBackLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(MFSwipeBackLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(MFSwipeBackLayout.class.getName());
        }
