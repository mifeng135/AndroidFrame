...
import com.mifeng.mf.MFApplication;
...
public class ImageLoader {
    ...
    private Drawable loadFile(String uri) {
        ...
        return new BitmapDrawable(MFApplication.instance.getResources(), bitmap);
    }

    private static Drawable loadResource(String iconSource) {
        return ResourceDrawableIdHelper.getInstance().getResourceDrawable(MFApplication.instance, iconSource);
    }

    private StrictMode.ThreadPolicy adjustThreadPolicyDebug() {
        StrictMode.ThreadPolicy threadPolicy = null;
        if (MFApplication.instance.isDebug()) {
    ...
    private void restoreThreadPolicyDebug(@Nullable StrictMode.ThreadPolicy threadPolicy) {
        if (MFApplication.instance.isDebug() && threadPolicy != null) {
